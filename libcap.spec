...
Source0  : https://mirrors.kernel.org/pub/linux/libs/security/linux-privs/libcap2/libcap-2.67.tar.xz
...
%prep
%setup -q -n libcap-2.67
cd %{_builddir}/libcap-2.67
pushd ..
cp -a libcap-2.67 build32
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1675463197
...
/usr/lib64/libcap.so.2.67
/usr/lib64/libpsx.so.2
/usr/lib64/libpsx.so.2.67
/usr/lib64/security/pam_cap.so

%files lib32
%defattr(-,root,root,-)
/usr/lib32/libcap.so.2
/usr/lib32/libcap.so.2.67
/usr/lib32/libpsx.so.2
/usr/lib32/libpsx.so.2.67
