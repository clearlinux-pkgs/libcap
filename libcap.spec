...
Source0  : https://mirrors.kernel.org/pub/linux/libs/security/linux-privs/libcap2/libcap-2.73.tar.gz
...
%prep
%setup -q -n libcap-2.73
cd %{_builddir}/libcap-2.73
pushd ..
cp -a libcap-2.73 build32
popd
pushd ..
cp -a libcap-2.73 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1733164065
