...
Version  : 2.71
Release  : 67
URL      : https://mirrors.kernel.org/pub/linux/libs/security/linux-privs/libcap2/libcap-2.71.tar.gz
Source0  : https://mirrors.kernel.org/pub/linux/libs/security/linux-privs/libcap2/libcap-2.71.tar.gz
...
%prep
%setup -q -n libcap-2.71
cd %{_builddir}/libcap-2.71
pushd ..
cp -a libcap-2.71 build32
popd
pushd ..
cp -a libcap-2.71 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1730129424
