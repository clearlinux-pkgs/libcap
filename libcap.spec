...
Source0  : https://mirrors.kernel.org/pub/linux/libs/security/linux-privs/libcap2/libcap-2.65.tar.xz
...
%prep
%setup -q -n libcap-2.65
cd %{_builddir}/libcap-2.65
pushd ..
cp -a libcap-2.65 build32
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1658154321
...
cp %{_builddir}/libcap-2.65/License %{buildroot}/usr/share/package-licenses/libcap/8e551c102f36c6be65530854d7a70f82a4ed5d60
cp %{_builddir}/libcap-2.65/cap/License %{buildroot}/usr/share/package-licenses/libcap/6d8ab02e1ae1a8055a645ff26e2ff610f22f5891
cp %{_builddir}/libcap-2.65/pam_cap/License %{buildroot}/usr/share/package-licenses/libcap/bf77cfae0a77bd405578c6f49be4d672ef6ecdf7
cp %{_builddir}/libcap-2.65/psx/License %{buildroot}/usr/share/package-licenses/libcap/93e9b5cba3e7048124348d650d8ccda48f8e5696
pushd ../build32/
...
/usr/lib64/libcap.so.2.65
/usr/lib64/libpsx.so.2
/usr/lib64/libpsx.so.2.65
/usr/lib64/security/pam_cap.so

%files lib32
%defattr(-,root,root,-)
/usr/lib32/libcap.so.2
/usr/lib32/libcap.so.2.65
/usr/lib32/libpsx.so.2
/usr/lib32/libpsx.so.2.65
