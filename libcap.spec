...
Version  : 2.72
Release  : 68
URL      : https://mirrors.kernel.org/pub/linux/libs/security/linux-privs/libcap2/libcap-2.72.tar.gz
Source0  : https://mirrors.kernel.org/pub/linux/libs/security/linux-privs/libcap2/libcap-2.72.tar.gz
...
%prep
%setup -q -n libcap-2.72
cd %{_builddir}/libcap-2.72
pushd ..
cp -a libcap-2.72 build32
popd
pushd ..
cp -a libcap-2.72 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1731434299
...
/usr/lib32/libcap.so.2.72
/usr/lib32/libpsx.so.2
/usr/lib32/libpsx.so.2.72
