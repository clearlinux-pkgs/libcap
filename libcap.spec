...
Version  : 2.54
Release  : 46
URL      : https://www.kernel.org/pub/linux/libs/security/linux-privs/libcap2/libcap-2.54.tar.xz
Source0  : https://www.kernel.org/pub/linux/libs/security/linux-privs/libcap2/libcap-2.54.tar.xz
...
%prep
%setup -q -n libcap-2.54
cd %{_builddir}/libcap-2.54
pushd ..
cp -a libcap-2.54 build32
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1629995941
...
cp %{_builddir}/libcap-2.54/License %{buildroot}/usr/share/package-licenses/libcap/8e551c102f36c6be65530854d7a70f82a4ed5d60
cp %{_builddir}/libcap-2.54/cap/License %{buildroot}/usr/share/package-licenses/libcap/6d8ab02e1ae1a8055a645ff26e2ff610f22f5891
cp %{_builddir}/libcap-2.54/pam_cap/License %{buildroot}/usr/share/package-licenses/libcap/bf77cfae0a77bd405578c6f49be4d672ef6ecdf7
cp %{_builddir}/libcap-2.54/psx/License %{buildroot}/usr/share/package-licenses/libcap/93e9b5cba3e7048124348d650d8ccda48f8e5696
pushd ../build32/
...
/usr/lib32/libcap.so.2.54
/usr/lib32/libpsx.so.2
/usr/lib32/libpsx.so.2.54
