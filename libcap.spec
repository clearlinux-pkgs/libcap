...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1627932346
...
cp %{_builddir}/libcap-2.52/License %{buildroot}/usr/share/package-licenses/libcap/8e551c102f36c6be65530854d7a70f82a4ed5d60
cp %{_builddir}/libcap-2.52/cap/License %{buildroot}/usr/share/package-licenses/libcap/6d8ab02e1ae1a8055a645ff26e2ff610f22f5891
cp %{_builddir}/libcap-2.52/pam_cap/License %{buildroot}/usr/share/package-licenses/libcap/bf77cfae0a77bd405578c6f49be4d672ef6ecdf7
cp %{_builddir}/libcap-2.52/psx/License %{buildroot}/usr/share/package-licenses/libcap/93e9b5cba3e7048124348d650d8ccda48f8e5696
pushd ../build32/
