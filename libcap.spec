...
Source0  : https://mirrors.kernel.org/pub/linux/libs/security/linux-privs/libcap2/libcap-2.70.tar.gz
...
%prep
%setup -q -n libcap-2.70
cd %{_builddir}/libcap-2.70
pushd ..
cp -a libcap-2.70 build32
popd
pushd ..
cp -a libcap-2.70 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1716141065
...
/usr/lib64/libpsx.so.2.70
/usr/lib64/security/pam_cap.so

%files lib32
%defattr(-,root,root,-)
/usr/lib32/libcap.so.2
/usr/lib32/libcap.so.2.70
/usr/lib32/libpsx.so.2
/usr/lib32/libpsx.so.2.70
